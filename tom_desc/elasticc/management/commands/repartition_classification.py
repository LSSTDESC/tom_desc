...
class Command(BaseCommand):
    help = 'Make new partitions for the elasticc_brokerclassification table'
    ...
    def handle( self, *args, **options ):
        ...
        with conn.cursor( cursor_factory=psycopg2.extras.RealDictCursor ) as cursor:
            ...
            cursor.execute( 'SELECT DISTINCT "classifierId" FROM elasticc_brokerclassification_default '
        ...
        for i, brokerid in enumerate(whichbrokers):
            with conn.cursor() as cursor:
                ...
                try:
                    ...
                    # cursor.execute( "LOCK TABLE elasticc_brokerclassification" )
                    ...
                    sql = ( f'CREATE TABLE elasticc_brokerclassification_{brokerid} '
                            f'PARTITION OF elasticc_brokerclassification '
                    ...
                    sql = ( f'INSERT INTO elasticc_brokerclassification_{brokerid}'
                            ...
                            f'       "brokerMessageId","classifierId" '
                            f'FROM elasticc_brokerclassification_default '
                    ...
                    sql = ( f'DELETE FROM elasticc_brokerclassification_default '
                            f'WHERE "classifierId"=%(classifierid)s' )
                    cursor.execute( sql, { 'classifierid': brokerid } )
